...
@Component({
  selector: 'app-issues-summary-map',
  templateUrl: './issues-summary-map.component.html',
  styleUrls: ['./issues-summary-map.component.css']
})
export class IssuesSummaryMapComponent implements OnInit {
